...
//con configuration creiamo i bean che saranno gestiti da Spring e messi nel contesto
@PropertySource("application.properties") //serve per leggere le proprietà dal file application.properties
